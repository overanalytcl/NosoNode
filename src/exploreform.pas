...
type
  ...
  private
    ...
    procedure FGridFilesPrepareCanvas(Sender: TObject;
      aCol, aRow: Integer; aState: TGridDrawState);
    procedure FGridFilesDrawCell(Sender: TObject; aCol, aRow: Integer; aRect: TRect;
...
procedure ShowExplorer(const Directory: String;
  titulo, mascara, lineaaprocesar: String; fijarnombre: Boolean);
...
begin
  if (FGridFiles.Row > 0) and (Copy(FGridFiles.Cells[0, FGridFiles.Row], 1, 3) =
    '   ') then
  begin
    FActiveDir := FActiveDir + DirectorySeparator +
      Copy(FGridFiles.Cells[0, FGridFiles.Row], 4, Length(FGridFiles.Cells[0, FGridFiles.Row]));
...
procedure TExplorerForm.FGridFilesPrepareCanvas(Sender: TObject;
  aCol, aRow: Integer; aState: TGridDrawState);
begin
